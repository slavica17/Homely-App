...
import { getReceivedReservations, updateReservationStatus } from "@/data/reservations";
...
const ReservationRequests = () => {
  ...
  return (
    <Page>
      ...
      <Content>
        <Typography sx={{ fontSize: 24, fontWeight: 700, mb: 3 }}>Reservation requests</Typography>

        {loading ? (
          <CircularProgress />
        ) : reservations.length === 0 ? (
          <Typography sx={{ color: "#888888" }}>No requests yet.</Typography>
        ) : (
            ...
            <TableBody>
              {reservations.map((r) => (
                <TableRow key={r.id}>
                  ...
                  <TableCell>{r.tenantUsername}</TableCell>
